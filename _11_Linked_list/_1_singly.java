...
/* 
    Insert a new node at beginning of the linked-list:
        To insert a new node at the beginning we create a temp node with data as given x, 
...
/*
    Insert a new node at END of the linked-list:
        ...
        and assign it next node to null and its prev next node to ref of x, and return the new .
...
// CONCEPTS:
    ...
    static Node posiInsert(Node head, int x, int posi){
        ...
        for(int i = 1; i < posi-1 && curr != null ; i++ ) curr = curr.next;
